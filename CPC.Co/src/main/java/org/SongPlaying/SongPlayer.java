...
public class SongPlayer {
    ...
    public static boolean playAllSongs(ArrayList<Song> songs, boolean shuffle) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            SongPlayer player = new SongPlayer(song.audioFile); // FIXED: Use audioFile field
            player.play();
            ...
            while (playing) {
                ...
                System.out.print((shuffle ?
                        ...
                        "\n---------------------------------" +
                        "\nNow Running... " +
                        "\n▶ " + song.title + " by " + song.artist + // FIXED: Use public fields
                        "\n---------------------------------" +
                        "\na. Pause" +
                        "\nb. Resume" +
                        "\nc. Next Song" +
    ...
    public static boolean playSingleSong(Song song) {
        Scanner console = new Scanner(System.in);
        SongPlayer player = new SongPlayer(song.audioFile); // FIXED
        player.play();
        ...
        while (!stop) {
            System.out.print("\n====== PLAYING A SONG ONLY ======" +
                    "\n---------------------------------" +
                    "\nNow Running... " +
                    "\n▶ " + song.title + " by " + song.artist + // FIXED
                    "\n---------------------------------" +
                    "\na. Pause" +
                    "\nb. Resume" +
                    "\nc. Stop and Return" +
